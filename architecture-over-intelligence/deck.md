...
<p style="font-size:0.7em;margin-top:12px">A step you cannot undo. Once deleted, the audio is gone. Only I can answer: the model cannot see or click this. Every “yes” is saved in a log.</p>
</div>
<div>
